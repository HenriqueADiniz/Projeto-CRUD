...
public class DES {
	...
	public static void mostraAlgoritimo(String texto) throws IOException {
		...
		try {
			...
			RandomAccessFile arq1 = new RandomAccessFile("tmp/dadosCriptografadoDES.db", "rw");
			...
			RandomAccessFile arq2 = new RandomAccessFile("tmp/dadosDescriptografadoDES.db", "rw");
